        ...
        <div className="grid grid-cols-2 gap-20 items-center">
          <Reveal>
            <div className="h-[560px] bg-cover bg-center relative" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1486325212027-8081e485255e?w=800&q=80')" }}>
              <div className="absolute bottom-0 left-0 bg-[#C9A84C] text-[#0D0F12] px-5 py-2.5 text-[10px] font-bold tracking-[2px] uppercase">Waterproofing Specialists</div>
            </div>
          </Reveal>
          <Reveal delay={1}>
            ...
            <div className="text-[#F0EDE6] mb-5" style={{ fontFamily: 'var(--font-bebas, sans-serif)', fontSize: '56px' }}>WATERPROOFING</div>
            <p className="text-[15px] text-[#8A8F9E] leading-[1.9] mb-8">Singapore's tropical rainfall demands robust waterproofing. We apply proven membrane systems and liquid coatings that create an impenetrable barrier against moisture ingress — for flat roofs, terraces, RC slabs, and more.</p>
