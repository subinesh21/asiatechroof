    ...
    <>
        ...
        <div className="relative z-10 max-w-[1000px]">
          <Reveal>
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link 
                href="/contact" 
                className="bg-[#C9A84C] text-[#0D0F12] px-10 py-5 text-[14px] font-bold tracking-[2px] uppercase hover:bg-white transition-all text-center no-underline inline-block"
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
           <Reveal>
            ...
            <div className="prose prose-invert text-[#8A8F9E] text-[16px] leading-[1.8]">
               ...
               <h3 className="text-[#F0EDE6] text-[24px] mb-4 mt-8" style={{ fontFamily: 'var(--font-bebas, sans-serif)' }}>Our Corporate Services include:</h3>
           ...
           <Reveal delay={2}>
              <div className="space-y-4">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[#1C2130] p-6 text-center border-t-2 border-[#C9A84C]">
                       <div className="text-[36px] text-[#F0EDE6]" style={{ fontFamily: 'var(--font-bebas, sans-serif)' }}>500+</div>
                       <div className="text-[10px] text-[#8A8F9E] uppercase tracking-[1px]">Industrial Projects</div>
                    </div>
                    <div className="bg-[#1C2130] p-6 text-center border-t-2 border-[#C9A84C]">
                       <div className="text-[36px] text-[#F0EDE6]" style={{ fontFamily: 'var(--font-bebas, sans-serif)' }}>20+</div>
                       <div className="text-[10px] text-[#8A8F9E] uppercase tracking-[1px]">Years Expertise</div>
                    </div>
                 </div>
              </div>
           </Reveal>
      ...
      <section className="py-20 px-6 md:px-[60px] bg-[#0D0F12]">
         <div className="max-w-[1000px] mx-auto text-center">
            <Reveal>
               <h2 className="text-[#F0EDE6] mb-8" style={{ fontFamily: 'var(--font-bebas, sans-serif)', fontSize: '56px' }}>
