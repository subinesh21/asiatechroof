  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[700px]">
        <div className="text-[10px] tracking-[3px] uppercase text-[#C9A84C] mb-5 flex items-center gap-2.5">
        ...
        <p className="text-[18px] text-[#8A8F9E] max-w-[520px] leading-[1.7]">{subtitle}</p>
      </div>
    </section>
  );
}
