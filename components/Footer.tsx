    ...
    <footer className="border-t border-[rgba(201,168,76,0.2)] pt-16 md:pt-[72px] px-6 md:px-[60px] pb-9">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.5fr] gap-10 md:gap-[60px] mb-12 md:mb-[60px] pl-12 md:pl-22">
        ...
        <div className="pl-50">
          ...
          <div className="flex gap-3">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="w-[38px] h-[38px] border border-[rgba(201,168,76,0.2)] flex items-center justify-center text-[#111827] cursor-pointer transition-all duration-200 hover:border-[#3ef615] hover:text-[#3ef615] no-underline"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          ...
          <div className="flex flex-col mb-4">
            <span className="text-[11px] tracking-[2px] uppercase text-[#C9A84C] mb-1">Operating Hours</span>
            <span className="text-[15px] text-[#111827]">24/7 Emergency Response</span>
          </div>
        </div>
      </div>

      <div className="border-t border-[rgba(201,168,76,0.2)] pt-7 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-[13px] text-[#111827] tracking-[0.5px] text-center md:text-left">© 2026 Asia Tech Roofing. All rights reserved. Singapore.</p>
